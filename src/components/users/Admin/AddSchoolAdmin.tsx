...
export const AddSchoolAdminForm: React.FC = () => {
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-yellow-700">
                      L'ajout d'un établissement implique que l'ecole a donnee son appobation et que les informations sont deja verifiees.
                    </p>
                  </div>
                </div>
              </div>
